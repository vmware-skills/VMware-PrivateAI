...
from vmware_privateai.config import TargetConfig
from vmware_privateai.connection import ConnectionManager, _release_si
...
def _password(monkeypatch):
    ...
    monkeypatch.setenv("VMWARE_PRIVATEAI_VCENTER_PROD_PASSWORD", "test-only")
